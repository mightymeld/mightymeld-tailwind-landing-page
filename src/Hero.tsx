        ...
        <section className="bg-slate-100">
            <div className="container mx-auto flex flex-col items-center py-12 sm:py-24">
                ...
                <div className="flex justify-center items-center">
                    <button className="  bg-sky-700 transition duration-150 ease-in-out hover:bg-sky-600 lg:text-xl lg:font-bold  rounded text-white px-4 sm:px-10 py-2 sm:py-4 text-sm">Get Started Now</button>
