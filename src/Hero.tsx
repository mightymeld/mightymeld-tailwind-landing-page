    ...
    return (
        <section className="bg-slate-100">
            <div className="container mx-auto flex flex-col items-center py-12 sm:py-24">
                ...
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente facere officia, doloribus excepturi illo rerum natus repellendus aliquam commodi quisquam suscipit dicta voluptatum. Architecto ullam quis recusandae esse quaerat nam.
